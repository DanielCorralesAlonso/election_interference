seed_lexicon = {
    "propaganda": ["propaganda", "disinformation", "misinformation", "spread_lie", "influence_operation", "influence", "influence_campaign", "spread_propaganda", "misinform", "disinformation_campaign", "information_warfare", "information_operation"],
    "election_interference": ["election_interference", "foreign_interference", 'interference', "election_meddling", "vote_manipulation", "influence_election", "influence_elections", "election_influence", "voter_fraud", "election_integrity", "rig_election"],
    "hacking": ["hack", "hacking", "cyber_attack", "cyberattack", "cyber_espionage", "hacker", "malware", "ransomware", "spyware", "breach"],
