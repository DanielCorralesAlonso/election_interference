seed_lexicon = {
    ...
    "Election Interference": ["election_interference",   "election_meddling", "vote_manipulation", "influence_election", "voter_fraud"], # "foreign_interference", 'interference',"meddling","influence_elections", "election_influence", "voter_fraud", "election_integrity", "rig_election"],
    "Hacking": ["hack", "cyber_attack", "cyberattack", "cyber_espionage", "breach"], # "hacking", "hacker"
    "Social Media": ["social_media", "facebook", "twitter", "instagram", "tiktok", "reddit", "youtube", "internet", "whatsapp", "telegram", ], # "app", "social_network", "telegram_channel","social_platform", "tweet", "influencer"],
    "Artificial Intelligence": ["artificial_intelligence", "ai", "generative_ai"], # "ai_generate", "ai_bot", "generative_ai", "chatbot", "large_language_model", "deepfake"],
    "US Elections": [ "presidential_election", "trump", "biden", "harris", "democrats", "republicans", "democratic_party", "republican_party"],
